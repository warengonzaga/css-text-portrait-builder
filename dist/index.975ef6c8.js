...
const setText = ()=>{
    ...
    textPortrait.innerHTML = `${_configJson.text} `.repeat(Math.ceil(maxChar / textCount)).substring(0, maxChar + 1);
};
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire14d3")
